            ...
            <div className="space-y-4">
                <div className="flex justify-between items-end">
                    <div className="text-[#DC3173] text-sm font-bold">
                        {t("step")} 2 {t("of")} 3: <span className="font-medium">{t("verify_your_identity")}</span>
                    </div>
            ...
            <div className="flex items-center justify-center min-h-screen bg-slate-50 my-10">
                <Card className="w-full max-w-125 shadow-lg border-t-4 border-t-[#DC3173] rounded-xl overflow-hidden">
                    <CardContent className="pt-10 px-8 pb-10 flex flex-col items-center text-center">
                        ...
                        <h2 className="text-2xl font-bold text-slate-800">{t("verify_your_identity")}</h2>
                        <p className="text-sm text-slate-500 mt-3 leading-relaxed">
                            {t("we_have_send_otp")}<br />
                            <span className="font-bold text-slate-700">{email || ""}</span>. {t("please_enter_otp")}.
                        </p>
